...
ECHO XCOPY /s /c /i /y AttackServices\ArpPoisoning\bin\%SOLUTIONCONFIG%\*.dll %AS_DNSPOISONING_DIR%
XCOPY /s /c /i /y AttackServices\ArpPoisoning\bin\%SOLUTIONCONFIG%\*.dll %AS_DNSPOISONING_DIR% >>%OUTPUTFILE%
