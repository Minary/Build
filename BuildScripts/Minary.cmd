...
::SET MINARY_PAYLOADS_ROOT=%MINARY_ROOT_DIR%..\MinaryPayloads\
...
ECHO copy %MINARY_ROOT_DIR%Minary\Minary.manifest %BUILD_DIR%
COPY %MINARY_ROOT_DIR%Minary\Minary.manifest %BUILD_DIR% >>%OUTPUTFILE%
IF %ERRORLEVEL% NEQ 0 EXIT /B %ERRORLEVEL%
...
ECHO copy %MINARY_ROOT_DIR%Minary\Minary.ico %IMAGES_DIR%
COPY %MINARY_ROOT_DIR%Minary\Minary.ico %IMAGES_DIR% >>%OUTPUTFILE%
IF %ERRORLEVEL% NEQ 0 EXIT /B %ERRORLEVEL%

:: ECHO xcopy /s /c /i %MINARY_PAYLOADS_ROOT%* %PAYLOADS_DIR%
:: xcopy /s /c /i %MINARY_PAYLOADS_ROOT%* %PAYLOADS_DIR% >>%OUTPUTFILE%
:: IF %ERRORLEVEL% NEQ 0 EXIT /B %ERRORLEVEL%
