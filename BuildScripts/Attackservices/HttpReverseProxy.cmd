...
SET HTTPREVERSEPROXY_ATTACKSERVICE_DIR=AttackServices\HttpReverseProxy\bin\%SOLUTIONCONFIG%\AS_HttpReverseProxy.dll
...
ECHO COPY %HTTPREVERSEPROXY_ATTACKSERVICE_DIR% %HTTPREVERSEPROXY_DSTDIR%
COPY %HTTPREVERSEPROXY_ATTACKSERVICE_DIR% %HTTPREVERSEPROXY_DSTDIR% >>%OUTPUTFILE%
IF %ERRORLEVEL% NEQ 0 EXIT /B %ERRORLEVEL%
